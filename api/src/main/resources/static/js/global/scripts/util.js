 ...
 * artTemplate 自定义方法
 *
 * 判断id是否包含在ids里面,如果包含则返回"selected",用于修改页设置Select2选中值
 *
 * @param id : 目标值:例如:1
 * @param ids : 逗号分隔的字符串:例如:1,2,3
 * @example  在模板中 <option value="{{id}}" {{id | isContain:id}}>{{value}}</option>
 */
template.helper("isContain", function (id, ids) {
    var flag = "";
